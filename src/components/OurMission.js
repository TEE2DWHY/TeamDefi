                ...
                <div className="container">
                    <div className="row mission">
                        <div className="col-lg-9">
                            <h1>Our Mission</h1>
                            <p style={{ color: "grey" }}>Team Defi is a free education platform designed to help users easily learn about cryptocurrency, with simple, relevant and engaging content.
                                <br /> <br />
