        ...
        <nav className="navbar navbar-expand-lg nav-header" >
            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <button className="nav-link active nav-nav join-community" aria-current="page" href="/#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa-brands fa-telegram" style={{ marginRight: "5px", fontSize: "16px" }}></i> JOIN COMMUNITY</button>
                    {/* Modal */}
