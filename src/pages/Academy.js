        ...
        <>
            ...
            <div className="container">
                <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                    <h3 class="display-6 fw-normal">Related Technologies...</h3>
                    <p class="fs-5 text-muted">Are you interested in acquiring more tech-related skills like front-end engineering, back-end engineering , or blockchain development? Our knowledgeable staff has you covered.</p>
                </div>
                ...
                <div className="accordion" id="accordionExample">
                    <div className="accordion-item">
                        <h2 className="accordion-header" id="headingOne">
                            <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style={{ fontSize: "18px", lineHeight: "23px", letterSpacing: "-.6px", color: "#181818", fontWeight: "600" }}>
                                Bitcoin is a bubble
                            </button>
                        </h2>
                    ...
                    <div className="accordion-item">
                        <h2 class="accordion-header" id="headingTwo">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style={{ fontSize: "18px", lineHeight: "23px", letterSpacing: "-.6px", color: "#181818", fontWeight: "600" }}>
                    ...
                    <div className="accordion-item">
                        <h2 className="accordion-header" id="headingFour">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour" style={{ fontSize: "18px", lineHeight: "23px", letterSpacing: "-.6px", color: "#181818", fontWeight: "600" }}>
                    ...
                    <div className="accordion-item">
                        <h2 className="accordion-header" id="headingFive">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive" style={{ fontSize: "18px", lineHeight: "23px", letterSpacing: "-.6px", color: "#181818", fontWeight: "600" }}>
                    ...
                    <div className="accordion-item">
                        <h2 className="accordion-header" id="headingSix">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix" style={{ fontSize: "18px", lineHeight: "23px", letterSpacing: "-.6px", color: "#181818", fontWeight: "600" }}>
