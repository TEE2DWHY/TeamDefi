        ...
        <>
            ...
            <section id="learn">
                <div className="course">
                    <br /> <br />
                    <h2 style={{ textAlign: "center", fontWeight: "900" }}>Choose want you want to learn <br></br><br /><i class="fa-brands fa-bitcoin"></i> <i class="fa-brands fa-ethereum"></i> <i class="fa-brands fa-hive"></i></h2>
