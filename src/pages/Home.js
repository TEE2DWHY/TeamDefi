        ...
        <>
            ...
            <section id="learn">
                <div className="course">
                    <br /> <br />
                    <h2 style={{ textAlign: "center", fontWeight: "bolder" }}>Resource... <br></br><br /><i class="fa-brands fa-bitcoin"></i> <i class="fa-brands fa-ethereum"></i> <i class="fa-brands fa-hive"></i></h2>
